	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-9">
					<form action="../repositorio/RetirarProfessor.php" method="POST">
						<label>Siape do professor a ser removido: </label><input class="form-control" type="text" name="siape" id="siapeID"/> <br>
